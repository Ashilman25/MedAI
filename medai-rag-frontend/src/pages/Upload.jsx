    ...
    <section className='mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10'>
      ...
      <div className='rounded-2xl border border-dashed border-gray-300 bg-white p-8 shadow-card'>
        ...
        <div className='flex gap-2 mt-4'>
          <button onClick={onUpload} className='px-4 py-2 rounded-xl bg-medical-green text-white'>Ingest</button>
          <button onClick={()=>{setFile(null); setResult(null)}} className='px-4 py-2 rounded-xl border border-gray-300 bg-white'>Reset</button>
        </div>
